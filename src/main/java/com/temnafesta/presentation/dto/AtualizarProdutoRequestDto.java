...
@Schema(description = "Dados para atualização completa de um produto")
public record AtualizarProdutoRequestDto(
        ...
        @Schema(description = "Preço de venda do produto", example = "59.90")
        ...
        @Schema(description = "Status atualizado do produto", example = "true")
